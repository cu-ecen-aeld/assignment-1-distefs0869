...
SVC_NAME="actions.runner.cu-ecen-aeld-assignment-1-distefs0869.Ubuntu-22.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (cu-ecen-aeld-assignment-1-distefs0869.Ubuntu-22)"
